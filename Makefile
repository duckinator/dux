...
CFLAGS=-m32 -Wall -Wextra -fno-builtin -fno-stack-protector -Iinclude -g
...
OBJS+=kernel/panic.o kernel/timer.o kernel/vsprintf.o kernel/printk.o kernel/task.o kernel/syscall.o kernel/misc.o
#drivers/floppy.o
