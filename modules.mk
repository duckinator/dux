...
uart.exe: krnllib.lib libc.lib hal.lib src/modules/uart.o
	@${LD} -o src/modules/uart.exe ${LDFLAGS} -Ttext 0x200000 src/modules/uart.o -Lsrc/lib/krnllib src/lib/krnllib/krnllib.lib -Lsrc/lib/libc src/lib/libc/libc.lib -Lsrc/metodo/hal src/metodo/hal/hal.lib
